...
Dvir_reps <-  read.delim("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/D_virilis.all.phobos.simple.out", header=FALSE)
...
```{r}
Dnova.simple.out.all <- read.delim("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/Dnovamex.all.simple.out", header=FALSE)
...
D_americana_reps <-  read.delim("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/D_americana_all.phobos.simple.out", header=FALSE)
...
Dhyd.simple.out.all <- read.delim("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/Dhydei.simple.out.all.filtered", header=FALSE)
colnames (Dhyd.simple.out.all) <- c("kmer", "count")

# summarize the sequences
Dhyd.simple <- tapply(Dhyd.simple.out.all$count, Dhyd.simple.out.all$kmer, sum)

assembly_size <- 1.64E8
...
repeatspan_df <- rbind(Dvir_df, Dnova_df, Dhyd_df)
...
Dvir_pore_reps <-  read.delim("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/Dvir.nanopore.phobos.all.simple.out", header=FALSE)
...
vir_sat <- read.csv("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/virilis_satellite_quant.csv", header=T)
vir_sat
...
```{r}
strand_bias <- read.csv(file="/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/LongRead_kseek_Phobos/ForR/Strand_bias_summary2.csv", header=T)
