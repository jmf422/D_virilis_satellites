...
kseek_data <- read.csv("~/Documents/AndyLab/Illumina-sequencing/melpolyteny.rep.compiled.GCcorr")
...
data2 <- read.delim ('/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Polyteny/ForR/Dvir_polyteny.rep.compiled')
...
depth <- c(18.44, 4.597)
names(depth) <- c("Dvir_disks", "Dvir_flies")
data3 <- read.delim ('/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Polyteny/ForR/Dvir_polyteny.allreads.rep.compiled')
