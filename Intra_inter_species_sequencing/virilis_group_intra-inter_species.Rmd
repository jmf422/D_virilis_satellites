...
americana_fus <- read.csv('/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/ForR/americana_fusion_status.csv')
...
ggplot(data = plot_data, aes(x = Status, y = AAACTAC)) + 
  geom_boxplot() +
  geom_jitter(color="tomato") +
  geom_text(aes(label=Row.names),hjust=0, vjust=0) +
  theme_bw() +
...
``` {r fig1, fig.height=10, fig.width=8}
# I will show some representative histograms for AAACTAT. there were not noticable differences between strains. 

vir51.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir51.AAACTAT.div")

vir86.div2 <- read.table("//Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir86.AAACTAT.div")

vir48.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir48.AAACTAT.div")

vir00.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir00.AAACTAT.div")

vir08.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir08.AAACTAT.div")

vir85.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir85.AAACTAT.div")

vir9.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir9.AAACTAT.div")

vir47.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir47.AAACTAT.div")

vir52.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir52.AAACTAT.div")

vir118.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir118.AAACTAT.div")

vir49.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir49.AAACTAT.div")

vir87f.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir87f.AAACTAT.div")

vir87m.div2 <- read.table("/Users/jullienflynn/Documents/AndyLab/Heterochromatin/PacBio_scripts/Revised_scripts/D_virilis_satellites_analysis/Intra_inter_species_sequencing/div_files/vir87m.AAACTAT.div")  

par(mfrow = c(4, 3))
hist(vir51.div2$V1, xlim=c(94,100))
hist(vir48.div2$V1, xlim=c(94,100))
hist(vir86.div2$V1, xlim=c(94,100))
hist(vir00.div2$V1, xlim=c(94,100))
hist(vir08.div2$V1, xlim=c(94,100))
hist(vir9.div2$V1, xlim=c(94,100))
hist(vir85.div2$V1, xlim=c(94,100))
hist(vir47.div2$V1, xlim=c(94,100))
hist(vir52.div2$V1, xlim=c(94,100))
hist(vir118.div2$V1, xlim=c(94,100))
hist(vir49.div2$V1, xlim=c(94,100))
hist(vir87f.div2$V1, xlim=c(94,100))  
