...
# make simplified reference genome
#GENOME=/fs/cbsufsrv5/data2/jmf422/virilis_diversity/mapping/GCcorr/Genomes/$1.canu.fasta
GENOME=/fs/cbsufsrv5/data2/jmf422/virilis_diversity/mapping/GCcorr/results/testing/$1.canu.fasta.masked
...
#
# Where is it?
CHROM_SIZES=/fs/cbsufsrv5/data2/jmf422/virilis_diversity/mapping/GCcorr/Genomes/$1.canu.contigs
...
BAMFOLDER=/fs/cbsufsrv5/data2/jmf422/virilis_diversity/mapping/$1_bam/subset/
...
RES_FOLDER=/fs/cbsufsrv5/data2/jmf422/virilis_diversity/mapping/GCcorr/results/testing/
